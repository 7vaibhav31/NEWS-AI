...
Follow these steps to set up the project locally on your machine (using XAMPP or Laragon) so you can test the AI Image Generation feature tomorrow.
...
php artisan serve
```
This will start your backend admin panel at: **`http://127.0.0.1:8000`**

---

## Step 5: Test the Feature in the Admin Panel
1. Open `http://127.0.0.1:8000/admin` (or the admin login page) in your web browser.
2. Go to **News Management** -> **AI News Engine** in the sidebar.
3. Update the settings:
   * **Active Provider**: Select **Google Gemini** (or OpenAI/Claude).
   * **Gemini API Key**: Paste the **free Gemini API Key** you obtained from Google AI Studio.
   * **Enable AI Image Generation**: Turn the switch **ON**.
   * **Image Generator Provider**: Select **Free AI (Pollinations.ai)**.
4. Click **Save Settings**.
5. Click the green **Generate Now (test run)** button.
6. Check the logs and check the generated news article. It should have a beautiful cover image generated by the AI based on its prompt!
