...
Route::group(['middleware' => ['auth:admin', 'checkLogin']], function () {
    Route::group(['middleware' => 'language'], function () {
        ...
        // AI News Engine (added module)
        Route::get('ai-news', [AiNewsController::class, 'index'])->name('ai-news.index');
        Route::post('ai-news', [AiNewsController::class, 'update'])->name('ai-news.update');
        Route::post('ai-news/generate', [AiNewsController::class, 'generateNow'])->name('ai-news.generate');
        Route::get('ai-news/logs', [AiNewsController::class, 'logs'])->name('ai-news.logs');
